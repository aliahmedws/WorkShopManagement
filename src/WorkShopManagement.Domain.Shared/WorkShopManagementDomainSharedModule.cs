...
public class WorkShopManagementDomainSharedModule : AbpModule
{
    ...
    {
        WorkShopManagementGlobalFeatureConfigurator.Configure();
        WorkShopManagementModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<WorkShopManagementDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<WorkShopManagementResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/WorkShopManagement");
        ...
        {
            options.MapCodeNamespace("WorkShopManagement", typeof(WorkShopManagementResource));
        });
    }
}
