...
namespace WorkShopManagement.Migrations
{
    ...
    [Migration("20260116164455_UpdatedCheckInReport_FieldDataTypes")]
    partial class UpdatedCheckInReport_FieldDataTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkShopManagement.Cars.Car", b =>
                {
                    ...
                    b.Property<string>("CncColumn")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("CncFirewall")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("WorkShopManagement.Cars.CarOwner", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkShopManagement.CheckLists.CheckList", b =>
                {
                    ...
                    b.Property<bool?>("EnableCheckInReport")
                        .HasColumnType("bit");

                    b.Property<bool?>("EnableIssueItems")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AppCheckLists", (string)null);
                });

            modelBuilder.Entity("WorkShopManagement.EntityAttachments.EntityAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkShopManagement.Issues.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DeteriorationType")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OriginStage")
                        .HasColumnType("int");

                    b.Property<string>("QualityControlAction")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");
                    ...
                    b.Property<string>("RectificationAction")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");
                    ...
                    b.Property<string>("RepairerAction")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");

                    b.Property<string>("RepairerNotes")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");
                    ...
                    b.HasIndex("CarId", "SrNo")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("AppIssues", null, t =>
                        {
                            t.HasCheckConstraint("CK_Issues_SrNo_Range", "[SrNo] >= 1 AND [SrNo] <= 1000");

                            t.HasCheckConstraint("CK_Issues_XPercent_Range", "[XPercent] >= 0 AND [XPercent] <= 100");

                            t.HasCheckConstraint("CK_Issues_YPercent_Range", "[YPercent] >= 0 AND [YPercent] <= 100");
                        });
                });

            modelBuilder.Entity("WorkShopManagement.ListItems.ListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppListItems", (string)null);
                });

            modelBuilder.Entity("WorkShopManagement.LogisticsDetails.ArrivalEstimates.ArrivalEstimate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("LogisticsDetailId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LogisticsDetailId");

                    b.ToTable("AppArrivalEstimates", (string)null);
                });
            ...
            modelBuilder.Entity("WorkShopManagement.LogisticsDetails.LogisticsDetail", b =>
                {
                    ...
                    b.Property<DateTime?>("ActualPortArrivalDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ActualScdArrivalDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("CreStatus")
                        .HasColumnType("int");

                    b.Property<DateTime?>("CreSubmissionDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("DeliverNotes")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");
            ...
            modelBuilder.Entity("WorkShopManagement.ModelCategories.ModelCategory", b =>
                {
                    ...
                    b.ToTable("AppModelCategories", (string)null);
                });
            ...
            modelBuilder.Entity("WorkShopManagement.QualityGates.QualityGate", b =>
                {
                    ...
                    b.ToTable("AppQualityGates", (string)null);
                });
            ...
            modelBuilder.Entity("WorkShopManagement.RadioOptions.RadioOption", b =>
                {
                    ...
                    b.ToTable("AppRadioOptions", (string)null);
                });

            modelBuilder.Entity("WorkShopManagement.Recalls.Recall", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRecalls", (string)null);
                });

            modelBuilder.Entity("WorkShopManagement.VinInfos.VinInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("ImagesLastUpdated")
                        .HasColumnType("datetime2");

                    b.Property<string>("ImagesResponse")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("SpecsLastUpdated")
                        .HasColumnType("datetime2");

                    b.Property<string>("SpecsResponse")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorkShopManagement.CarModels.CarModel", b =>
                {
                    ...
                    b.OwnsOne("WorkShopManagement.EntityAttachments.FileAttachments.FileAttachment", "FileAttachments", b1 =>
                        {
            ...
            modelBuilder.Entity("WorkShopManagement.Cars.Car", b =>
                {
                    b.HasOne("WorkShopManagement.CarModels.CarModel", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WorkShopManagement.Cars.CarOwner", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkShopManagement.CheckLists.CheckList", b =>
                {
                    b.HasOne("WorkShopManagement.CarModels.CarModel", "CarModels")
                        .WithMany("CheckLists")
                        .HasForeignKey("CarModelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WorkShopManagement.EntityAttachments.EntityAttachment", b =>
                {
                    ...
                    b.OwnsOne("WorkShopManagement.EntityAttachments.FileAttachments.FileAttachment", "Attachment", b1 =>
                        {
            ...
            modelBuilder.Entity("WorkShopManagement.ListItems.ListItem", b =>
                {
                    b.HasOne("WorkShopManagement.CheckLists.CheckList", "CheckLists")
                        .WithMany("ListItems")
                        .HasForeignKey("CheckListId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WorkShopManagement.LogisticsDetails.ArrivalEstimates.ArrivalEstimate", b =>
                {
                    b.HasOne("WorkShopManagement.LogisticsDetails.LogisticsDetail", null)
                        .WithMany("ArrivalEstimates")
            ...
            modelBuilder.Entity("WorkShopManagement.ModelCategories.ModelCategory", b =>
                {
                    b.OwnsOne("WorkShopManagement.EntityAttachments.FileAttachments.FileAttachment", "FileAttachments", b1 =>
                        {
                            b1.Property<Guid>("ModelCategoryId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkShopManagement.RadioOptions.RadioOption", b =>
                {
                    b.HasOne("WorkShopManagement.ListItems.ListItem", "ListItems")
