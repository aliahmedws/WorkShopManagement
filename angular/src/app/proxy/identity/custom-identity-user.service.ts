...
export class CustomIdentityUserService {
  ...
  create = (input: IdentityUserCreateDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, IdentityUserDto>({
      method: 'POST',
      url: '/api/app/custom-identity-user',
      body: input,
    },
  ...
  delete = (id: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, void>({
      method: 'DELETE',
      url: `/api/app/custom-identity-user/${id}`,
    },
    { apiName: this.apiName,...config });
  ...
  findByEmail = (email: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, IdentityUserDto>({
      method: 'POST',
      url: '/api/app/custom-identity-user/find-by-email',
      params: { email },
    },
    { apiName: this.apiName,...config });
  ...
  findByUsername = (userName: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, IdentityUserDto>({
      method: 'POST',
      url: '/api/app/custom-identity-user/find-by-username',
      params: { userName },
    },
    { apiName: this.apiName,...config });
  ...
  getAssignableRoles = (config?: Partial<Rest.Config>) =>
    this.restService.request<any, ListResultDto<IdentityRoleDto>>({
      method: 'GET',
      url: '/api/app/custom-identity-user/assignable-roles',
    },
    { apiName: this.apiName,...config });
  ...
  getRoles = (id: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, ListResultDto<IdentityRoleDto>>({
      method: 'GET',
      url: `/api/app/custom-identity-user/${id}/roles`,
    },
    { apiName: this.apiName,...config });
