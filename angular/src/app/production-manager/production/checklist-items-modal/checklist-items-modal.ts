...
//   // ✅ NEW: Store the editor name per listItemId
//   editedByInfo: Record<string, string> = {};
...
//         const editorName = r.modifierName || r.creatorName || '-';
//         this.editedByInfo[listItemId] = editorName;
