...
export class ProductionDetailsModal {
  ...
  moveToPostProduction() {
    ...
    this.confirm
      .confirmAction('::ConfirmMoveToPostProductionMessage', '::ConfirmMoveToPostProductionTitle')
  ...
  moveToAwaitingTransportProduction() {
    ...
    this.confirm
      .confirmAction('::ConfirmMoveToAwaitingTransport', '::ConfirmMoveToAwaitingTitle')
      .subscribe((status: Confirmation.Status) => {
        if (status !== Confirmation.Status.confirm) return;
  ...
  moveToDispatched() {
    ...
    this.confirm
      .confirmAction('::ConfirmMoveToDispatchedMessage', '::ConfirmMoveToDispatched')
      .subscribe((status: Confirmation.Status) => {
        if (status !== Confirmation.Status.confirm) return;
